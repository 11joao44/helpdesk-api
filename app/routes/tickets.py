...
async def send_email_route(payload: TicketSendEmail, service: DealService = Depends(get_service)): # Certifique-se que o schema está importado
...
@router.get("/deal/{deal_id}/{user_id}")
